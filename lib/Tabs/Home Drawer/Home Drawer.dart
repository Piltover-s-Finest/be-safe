        ...
        child: Column(
          ...
          children: [
            Container(
                ...
                child: const Text("Be Safe Settings", style: TextStyle(color: Colors.white,fontSize: 21,fontWeight: FontWeight.bold),)),
            Padding(
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    ...
                    Text("My profile",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    ...
                    Text("Related Account",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    ...
                    Text("My QR",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.wallpaper,size: 32,),
                    Text("My Rays",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.wallpaper,size: 32,),
                    Text("My Tests",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    ...
                    Text("My Medical paper",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: InkWell(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.medication,size: 32,),
                    Text("My Medications",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),)
                  ],
                ),
              ),
            ),
