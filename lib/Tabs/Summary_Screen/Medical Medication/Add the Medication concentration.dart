...
class AddMedicationConcentration extends StatefulWidget {
  ...
  @override
  State<AddMedicationConcentration> createState() => _AddMedicationConcentrationState();
}

class _AddMedicationConcentrationState extends State<AddMedicationConcentration> {
  int select3 = 0;
  @override
      ...
      body:SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Center(child: Text("Add Medication Concentration",
            ...
            const Text("  Choose a unit",style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
