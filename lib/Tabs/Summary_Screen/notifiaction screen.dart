            ...
            endActionPane: ActionPane(motion: const ScrollMotion(),
              ...
              title: const Row(
                ...
                children: [
                  ...
                  Text("Mina Magdy",style: TextStyle(fontWeight: FontWeight.w600),),
                  Text("2h Ago",style: TextStyle(fontSize: 12),)
                ],
              ),
              subtitle: const Text("Please someone who wants to be responsible for you and your health condition",
                maxLines: 2,
